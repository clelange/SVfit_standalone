...
namespace svFitStandalone
{
  ...
  */
  ...
  /**
     \class   MeasuredTauLepton SVfitStandaloneLikelihood.h "SVfitStandaloneLikelihood.h"
  ...
  */
  ...
  /**
   \class   SVfitStandaloneLikelihood SVfitStandaloneLikelihood.h "SVfitStandaloneLikelihood.h"
     ...
     SVfitStandaloneAlgorithm as defined in SVfitStandaloneAlgorithm.h in the same package. The SVfitLikelihood class
